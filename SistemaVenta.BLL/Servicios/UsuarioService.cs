...
namespace SistemaVenta.BLL.Servicios
{
    public class UsuarioService : IUsuarioService
    {
        ...
        {
            modelo.Clave = BCryptPasswordHasher.hashClave(modelo.Clave);
            try
            {
        ...
        public async Task<bool> Editar(UsuarioDTO modelo)
        {
            ...
            try
            {
                ...
                usuarioEncontrado.Clave = BCryptPasswordHasher.hashClave(usuarioModelo.Clave);
        ...
        public async Task<SesionDTO> ValidarCredenciales(string correo, string clave)
        {
            ...
            try
            {
                ...
                if (BCryptPasswordHasher.validarClave(clave,devolverUsuario.Clave)==false)
                    throw new TaskCanceledException("La Contraseña es Incorrecta");

                Console.WriteLine(devolverUsuario.IdUsuario);
